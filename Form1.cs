    ...
    public partial class Form1 : Form
    {
        ...
        private void InitializeUnitGridView()
        {
            if (unitGridView.Columns.Count == 0)  // Check if columns are already initialized
            {
                ...
                var cmbStatus = new DataGridViewComboBoxColumn { Name = "Status", HeaderText = "Status" };
                cmbStatus.Items.AddRange("Available", "Busy", "Unavailable", "En Route", "On Scene", "Off Duty");
